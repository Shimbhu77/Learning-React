      ...
      <main>
        ...
        <Container sx={{ py: 8 }} maxWidth="md">
          ...
          <Grid container spacing={4}>
            {data.map((card) => (
              <Grid item key={card.id.videoId} xs={12} sm={6} md={4}>
                <Card
                ...
                >
                  <CardMedia
                    ...
                    image={card.snippet.thumbnails.default.url}
                  />
                  ...
                  <CardActions>
                    <Button size="small" onClick={()=>{
                        const videoId = card.id.videoId; // Replace with the actual videoId from your JSON data
